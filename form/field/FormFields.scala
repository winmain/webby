...
import lib.form.{Form, FormWithDb}
...
trait FormFields {
  ...
  protected def formList[F <: Form](id: String, factory: () => F) = addField(new FormListField(id, factory))
  ...
  (id: String, factory: => F, parentField: Table[TR, MTR]#Field[Int, Int]) =
    addFormFieldWithDb(new FormListFieldWithDbLinked[F, TR, MTR, Table[TR, MTR]#Field[Int, Int]](id, () => factory, parentField, _.set(_, _)))
  ...
  (id: String, factory: => F, parentField: Table[TR, MTR]#Field[Int, Option[Int]]) =
    addFormFieldWithDb(new FormListFieldWithDbLinked[F, TR, MTR, Table[TR, MTR]#Field[Int, Option[Int]]](id, () => factory, parentField, (f, r, p) => f.set(r, Some(p))))
  ...
  (table: Table[TR, MTR])(id: String, factory: => F) =
    addFormFieldWithDb(new FormListFieldWithDbStandalone[F, TR, MTR](id, () => factory))

  protected def textField(id: String) = addField(new TextField(id))
  protected def longTextField(id: String) = addField(new TextField(id).maxLength(4000))
  ...
  protected def fioField(id: String) = addField(new FioField(id))
  ...
  protected def radioGroupOrSelectEnumField[E <: DbEnum](id: String, enum: E)(titleFn: E#V => String, emptyTitle: Option[String] = None)(implicit page: PageTrait): BaseSelectField[E#V] =
    if (page.desktop) radioGroupEnumField[E](id, enum)(titleFn, emptyTitle)
    else selectEnumField[E](id, enum)(titleFn, emptyTitle = emptyTitle)
  protected def radioGroupOldEnumDesktopField[E <: ScalaDbEnumCls[E]](id: String, enum: ScalaDbEnum[E])(titleFn: E => String, emptyTitle: Option[String] = None)(implicit page: PageTrait): BaseSelectField[E] =
    if (page.desktop) radioGroupOldEnumField[E](id, enum)(titleFn, emptyTitle)
    else selectOldEnumField[E](id, enum)(titleFn, emptyTitle = emptyTitle)
  ...
  protected def autocompleteListField[T](id: String, jsSourceFunction: String, jsSourceArg: Any = null, toJs: T => Int, fromJs: Int => Option[T]) =
    addField(new AutocompleteListField[T](id, jsSourceFunction = jsSourceFunction, jsSourceArg = jsSourceArg, toJs = toJs, fromJs = fromJs))
