...
if (!window.renderJsError) window.renderJsError = function(error) {
  ...
  div.style = "position: fixed; z-index: 999999; left: 0; top: 0; max-width: 80%; max-height: 100%; overflow: auto; background: #CA0E0E; color: #fff; font: 12px monospace; padding: 5px; box-shadow: 0 2px 10px 0 rgba(0,0,0,.5); line-height:150%"
