...
public final class FastBufferedWriter extends Writer {
     ...
     * flushing the buffer to the underlying stream as needed. If the requested length is at least
     * as large as the buffer, however, then this method will flush the buffer and write the
     * characters directly to the underlying stream. Thus redundant <code>BufferedWriter</code>s
     ...
     * <p>
     * If the value of the <tt>len</tt> parameter is negative then no characters are written. This
     * is contrary to the specification of this method in the
     * {@linkplain java.io.Writer#write(String,int,int) superclass}, which requires that
     * an {@link IndexOutOfBoundsException} be thrown.
     *
     * @param s
