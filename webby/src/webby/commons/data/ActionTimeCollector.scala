...
class ActionTimeCollector {
  ...
  private[data] val actionsHourly: Array[ValueStorage] = new Array[ValueStorage](24)
  private[data] val millisHourly: Array[ValueStorage] = new Array[ValueStorage](24)
...
object ActionTimeCollector {
  ...
  class ByteStorage(_capacity: Int) extends ValueStorage {
    private[data] val values: Array[Byte] = new Array[Byte](_capacity)
  ...
  class ShortStorage(_capacity: Int) extends ValueStorage {
    private[data] val values: Array[Short] = new Array[Short](_capacity)
  ...
  class IntStorage(_capacity: Int) extends ValueStorage {
    private[data] val values: Array[Int] = new Array[Int](_capacity)
  ...
  class LongStorage(_capacity: Int) extends ValueStorage {
    private[data] val values: Array[Long] = new Array[Long](_capacity)
