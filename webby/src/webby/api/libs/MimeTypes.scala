...
object MimeTypes {
  ...
  /**
    ...
    * @return the MIME type, if defined
    */
  def forFileName(name: String): Option[String] = forExtension(StringUtils.substringAfterLast(name, "."))

  def forPath(path: Path): Option[String] = forFileName(path.getFileName.toString)
  ...
  /**
    ...
    */
  def applicationTypes: Map[String, String] = App.maybeApp.flatMap {application =>
