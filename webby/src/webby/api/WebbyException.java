...
public class WebbyException extends UsefulException {
    ...
    public WebbyException(String title, String description, Throwable cause) {
    ...
    public WebbyException(String title, String description) {
    ...
    /**
     * Adds source attachment to a exception.
     */
    public static abstract class ExceptionSource extends WebbyException {
    ...
    /**
     * Adds any attachment to a exception.
     */
    public static abstract class ExceptionAttachment extends WebbyException {
    ...
    /**
     * Adds a rich HTML description to a Webby exception.
     */
